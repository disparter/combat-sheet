package com.dis.bot.commands.age.md;

import com.dis.bot.commands.SlashCommand;
import com.dis.bot.service.age.MentalDefenseService;
...
@Component
public class MentalAttackCommand implements SlashCommand {

    private final MentalDefenseService service;

    public MentalAttackCommand(MentalDefenseService service){
    ...
    public Mono<Void> handle(ChatInputInteractionEvent event) {
        ...
        return  event.reply()
            .withEphemeral(false)
            .withContent(String.format("%s was hit %s. (Mental Attack total score %d, [roll %d, bonus %d])",
